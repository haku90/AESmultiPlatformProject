...
void MixColumns(char state[4][4])
{
	...
	for (int i = 0; i < 4; i++)
	{
		...
		state[0][i] = x2[temp[0]] ^ x3[temp[1]] ^ temp[2] ^ temp[3];
		state[1][i] = temp[0] ^ x2[temp[1]] ^ x3[temp[2]] ^ temp[3];
		state[2][i] = temp[0] ^ temp[1] ^ x2[temp[2]] ^ x3[temp[3]];
		state[3][i] = x3[temp[0]] ^ temp[1] ^ temp[2] ^ x2[temp[3]];
		/*
...
void InvMixColumns(char state[4][4])
{
	...
	x9 = ((((temp[] << 1) << 1) << 1) ^ temp[])
	x11 = (((((temp[] << 1) << 1) ^ temp[]) << 1) + temp[])
	x13 = (((((temp[] << 1) ^ temp[]) << 1) << 1) + temp[])
	x14 = (((((temp[] << 1) ^ temp[]) << 1) ^ temp[]) << 1) 
	...
	*//*
	...
	for (int i = 0; i < 4; i++)
	{
		...
		state[0][i] = (((((temp[0] << 1) ^ temp[0]) << 1) ^ temp[0]) << 1) ^ (((((temp[1] << 1) << 1) ^ temp[1]) << 1) + temp[1]) ^ (((((temp[2] << 1) ^ temp[2]) << 1) << 1) + temp[2]) ^ ((((temp[3] << 1) << 1) << 1) ^ temp[3]);
		state[1][i] = ((((temp[0] << 1) << 1) << 1) ^ temp[0]) ^ (((((temp[1] << 1) ^ temp[1]) << 1) ^ temp[1]) << 1) ^ (((((temp[2] << 1) << 1) ^ temp[2]) << 1) + temp[2]) ^ (((((temp[3] << 1) ^ temp[3]) << 1) << 1) + temp[3]);
		state[2][i] = (((((temp[0] << 1) ^ temp[0]) << 1) << 1) + temp[0]) ^ ((((temp[1] << 1) << 1) << 1) ^ temp[1]) ^ (((((temp[2] << 1) ^ temp[2]) << 1) ^ temp[2]) << 1) ^ (((((temp[3] << 1) << 1) ^ temp[3]) << 1) + temp[3]);
		state[3][i] = (((((temp[0] << 1) << 1) ^ temp[0]) << 1) + temp[0]) ^ (((((temp[1] << 1) ^ temp[1]) << 1) << 1) + temp[1]) ^ ((((temp[2] << 1) << 1) << 1) ^ temp[2]) ^ (((((temp[3] << 1) ^ temp[3]) << 1) ^ temp[3]) << 1);
	}
}
*/
...
void AddRoundKey(char state[4][4], int iterRound)
{
	for (int i = 0; i < 4; i++)
	{
		for (int j = 0; j < 4; j++)
		{
			state[j][i] = state[j][i] ^ cipherKey[i + 4 * iterRound][j];
		}
	}
}
